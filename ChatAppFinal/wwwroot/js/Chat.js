...
//document.getElementById("createRoomRB").addEventListener("click", function (event) {
//    document.getElementById("existingRooms").hidden = true
//    document.getElementById("joinExistingRoomTitle").hidden = true
//    document.getElementById("roomCode").hidden = false
//    document.getElementById("enterRoomCodeTitle").hidden = false
//});

//document.getElementById("joinRoomRB").addEventListener("click", function (event) {
//    document.getElementById("existingRooms").hidden = false
//    document.getElementById("joinExistingRoomTitle").hidden = false
//    document.getElementById("roomCode").hidden = true
//    document.getElementById("enterRoomCodeTitle").hidden = true
//});

//if (joinRoomButton != null) {
//    joinRoomButton.addEventListener("click", function (event) {
//        var groupElement = document.getElementById("existingRooms");
//        var roomCodeText = document.getElementById("roomCode").value;
//        var option = document.createElement("option")
//        if (document.getElementById("createRoomRB").checked) {
//            if (roomCodeText != "") {
//                sessionStorage.currentRoom = roomCodeText;
//                option.text = roomCodeText;
//                option.value = roomCodeText;
//                closeNav();
//                closeRooms();
//                document.getElementById("roomCode").value = ""
//                document.getElementById("sendButtonToGroup").hidden = false
//                connection.invoke("CreateRoom", roomCodeText).catch(function (err) {
//                    return console.error(err.toString());
//                });
//                event.preventDefault();
//                connection.invoke("AddToGroup", roomCodeText).catch(function (err) {
//                    return console.error(err.toString());
//                });
//                event.preventDefault();
//            }
//        }
//        else if (document.getElementById("joinRoomRB").checked) {
//            closeNav();
//            closeRooms();
//            document.getElementById("sendButtonToGroup").hidden = false
//            connection.invoke("AddToGroup", existingRooms.value).catch(function (err) {
//                return console.error(err.toString());
//            });
//            sessionStorage.currentRoom = existingRooms.value;
//            event.preventDefault();
//        }
//    });
//}
...
//if (document.getElementById("sendButtonToGroup") != null) {
//    document.getElementById("sendButtonToGroup").addEventListener("click", function (event) {
//        var user = document.getElementById("userInput").value;
//        var message = document.getElementById("messageInput").value;
//        connection.invoke("SendMessageToGroup", sessionStorage.currentRoom, user, message).catch(function (err) {
//            return console.error(err.toString());
//        });
//        event.preventDefault();
//    });
